...
public class Updater {
    ...
    private File update = new File("game-update.zip");
    private File updateDir = new File("game-update");
    ...
    private boolean checkLicense(String license) {
        try {
            ...
            if (license != null && !license.isEmpty()) {
                URL licenseCheckUrl = new URL("http://hosting.service/validate.php?&license=" + license);
    ...
    private boolean checkVersion() {
        try {
            ...
            if (versionPath.exists()) {
                ...
                URL versionCheckUrl = new URL("http://hosting.service/download.php?version=" + myVersion);
    ...
    private boolean downloadUpdate(String license) {
        try {
            ...
            String spsLicenseUrl = "http://hosting.service/validate.php?&license=" + license;
            LaunchLogger.info("Downloading latest edition");
    ...
    private boolean applyUpdate() {
        try {
            ...
            File updateAssets = new File("game-update/assets");
            File baseAssets = new File("./");
            FileUtils.copyDirectoryToDirectory(updateAssets, baseAssets);

            File updateCore = new File("game-update/game.jar");
